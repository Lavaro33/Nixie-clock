...
#define CE  	PB3		//CE PIN
//#define CSN 	PB1		//Chip select PIN
#define SS 		PB4		//SS
#define MOSI 	PB5		//MOSI pin
#define MISO 	PB6		//MISO pin
#define SCK 	PB7		//SCK pin
...
#define CSN_HIGH 	SS_PORT |=  (1<<SS) 	//make CSN high macro
#define CSN_LOW  	SS_PORT &= ~(1<<SS)		//make CSN low macro
...
extern uint8_t nRF_RX_bufffer[MAXIMUM_PAYLOAD_SIZE+1];
