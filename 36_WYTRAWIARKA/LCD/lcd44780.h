...
// definicje dla podúwietlenia
#define LCD_BLIGHTPORT 		A
#define LCD_BLIGHT 			7
#define LCD_BLIGHT_OFF 		PORT(LCD_BLIGHTPORT) &= ~ (1<<LCD_BLIGHT)
#define LCD_BLIGHT_ON	 	PORT(LCD_BLIGHTPORT) |= (1<<LCD_BLIGHT)
