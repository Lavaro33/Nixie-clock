...
volatile uint16_t timer_debounce, prog_timer_nRF, prog_timer1, prog_timer2, prog_timer3,
		prog_timer4;		// timery programowe - przerwanie co 10ms (100Hz)
